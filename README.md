...
Install git if you have not already, and type "git install (module here)" for each module. Then run the script by typing "cd " then drag the "MCPSalerts" folder to terminal. Then type "python3 mcpsv2.py"
